...
public class DataRetriever {
    ...
    double getDriverRating(String nationalId) {
        String sql = "Select Rating , NumOfRatings from DriverAccount where NationalID = " + nationalId + ";";
        try {
            Connection conn = this.connect();
            stmt = conn.createStatement();
            ResultSet rs = stmt.executeQuery(sql);
            int aggregateRating = rs.getInt("Rating");
            int numOfRatings = rs.getInt("NumOfRatings");
            return (double) aggregateRating / numOfRatings;
