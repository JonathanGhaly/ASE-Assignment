...
public class UserUI implements UI {
    ...
    UserUI(User user) {
        ...
        if (user != null && user.getUserStatus().equals("idle") || user.getUserStatus().equals("Idle")) {
                        ...
                        case 1:
                            while (choice > - 1) {
                                ...
                                for (Offer offer : offers) {
                                    discount = new AreaDiscount(offer.getRideID());
                                    ...
                                    price = discount.getDiscount(price);
                                    discount = new PassengerNumDiscount(offer.getRideID());
                                    price = discount.getDiscount(price);
                ...
                case 3: {
                    ...
                    while (choice > - 1) {
                        ...
                        for (Offer offer : offers) {
                            ...
                            discount = new PassengerNumDiscount(offer.getRideID());
                            price = discount.getDiscount(price);
                            System.out.println(RideId++ + "- controller.Driver: " + offer.toString() + "\nPrice: " + price + "$\nRating: " + offer.getAvgRating());
                            System.out.println("===================================================");
                        }
                        System.out.println("Enter offer id to accept or 0 to refresh list or -1 to exit");
                        choice = in.nextInt();
                ...
                case 4: {
                    ...
                    while (choice > - 1) {
                        for (Ride ride : userOperations.getCarpoolRides(user, src, destination)) {
                            System.out.println("controller.Ride ID: " + ride.getRideID() + " Source: " + ride.getSourceArea() + " Destination: " + ride.getDestinationArea() + " Passenger Number: " + ride.getPassengersNo());
                        }
                        System.out.println("Enter 0 to refresh list or -1 to exit");
                        choice = in.nextInt();
                    }
