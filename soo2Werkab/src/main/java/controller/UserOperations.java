...
public class UserOperations {
    ...
    public void requestRide(User user, Area source, Area destination, int passengersNo, boolean aloneStatus) {
        if (aloneStatus) {
    ...
    public ArrayList<Offer> getOffers(User user) {
    ...
    public void rateDriver(User user, String driverName, int rating) {
    ...
    public ArrayList<Ride> getCarpoolRides(User user, Area source, Area destination) {
