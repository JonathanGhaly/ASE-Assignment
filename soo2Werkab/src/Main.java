...
public class Main {
    ...
    static DriverOperations driverOperations;
    ...
    public static void main(String[] args) {
        ...
        switch (choice) {
            ...
            case 2: {
                ...
                phoneNo = in.next();
                System.out.println("Please enter your birth year followed by your" +
                        " birth month followed by your birth day");
        ...
        while (isLoggedIn) {
            if (isDriver) {
                System.out.println("Your rating is " + driverOperations.showRating(driver));
